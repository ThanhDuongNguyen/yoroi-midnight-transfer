...
3. Xem hình minh họa bên dưới để biết cách truy cập Dapp Browser trong Eternl:
    ...
    ![Hướng dẫn mở Dapp Browser trong Eternl](eternl.png)
...
5. Điền địa chỉ ví Eternl người cho và người nhận
6. Tự động mở ví Eternl để ký message, có thể kiểm tra lại nội dung message trước khi ký, đảm bảo nội dung là "Assign accumulated Scavenger rights to: <địa chỉ ví người nhận>"
...
# Với ví Lace
1. Truy cập [https://thanhduongnguyen.github.io/yoroi-midnight-transfer/lace](https://thanhduongnguyen.github.io/yoroi-midnight-transfer/lace)
2. Điền địa chỉ ví Lace người cho và người nhận
3. Tự động mở ví Lace để ký message, có thể kiểm tra lại nội dung message trước khi ký, đảm bảo nội dung là "Assign accumulated Scavenger rights to: <địa chỉ ví người nhận>"
4. Sau khi ký xong, bên dưới hiển thị curl command để thực hiện gửi đến Scavenger.
5. Sao chép curl command và chạy trong terminal để hoàn tất quá trình chuyển quyền Scavenger.
6. Nội dung thành công sẽ hiển thị trong terminal.